...
The fresh post-CAP-023 capability-gap order is:
...
Rank 1 is an accepted-head correctness/reproducibility/artifact-footprint evidence
gate with no performance claim. Rank 2 maps exact CPU plus recursive-CopyData
application-profile composition, and rank 3 maps quantized arithmetic and
representation; ranks 2 and 3 remain readiness/red-probe work only and authorize no
