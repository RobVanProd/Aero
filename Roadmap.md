...
CAP-005 authorization and selected the now-accepted generic-transport slice. CAP-006
requires another fresh ranking against accepted CAP-005; no neighboring generic
topology inherits priority.
