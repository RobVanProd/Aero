...
> **Project status after CAP-001:** Aero remains a Minimal Prototype in correctness
> recovery, not a complete or stable language. Accepted master is
> `29c13fa32c2bef361ff33367b3b3839351e05534`; accepted compiler capability is
> CAP-001 at protected merge `25c1e2b239cba45f7b60c86f19629e9d768c77d0`.
...
> **CAP-002 candidate—not accepted:** runtime `int` selectors can update the existing
...
> 220-library/32-binary local gate pass. Exact-head Linux/Windows LLVM/native checks,
> protected merge, and post-merge verification remain pending. Writes through
