...
> **Project status after CAP-005:** Aero remains a Minimal Prototype in correctness
> recovery, not a complete or stable language. Accepted public and compiler-capability
> baseline is protected CAP-005 merge
> `59f7e47b476871fae8cecdf7e40900e0d1f1b377`.
...
> **CAP-006 local candidate:** one bound-free user-defined generic enum can be
...
> Clippy local gates pass. This is not accepted public capability: exact candidate
> workflows, pinned LLVM/Clang 22 Linux/Windows `-O0`/`-O2` execution, protected
> integration, and merge-head synchronization remain pending. Bounds/traits, named
