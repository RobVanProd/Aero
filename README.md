...
> CORE-089 is a local candidate multiple exclusive-reference checkpoint. Every
...
> target, and doc tests; public gates remain pending. Projections, reference results/escape/
