...
> `29019ff114f668a37eac429dc6f7905ab97fa6fb`; accepted compiler capability remains
> M1-001 merge `d7d1c7682911503470a19c97acb72d231824b193`. The corrective roadmap prioritizes one
...
> **CAP-001 local candidate—not yet public acceptance:** nonconstant `int` reads from
...
> library tests, and the complete root gate pass. Public Linux/Windows failure runs,
> exact-head checks, protected merge, and post-merge verification remain pending.
