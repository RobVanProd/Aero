...
behavior. CAP-032/P1 has resumed from accepted CAP-034 and explicitly records
that adding its fourth public Rust enum variant requires downstream exhaustive
matches to add the new arm or a catch-all.
...
Complete `CAP-032-EXACT-I32-RECORD-RESULT-PROFILE` from accepted CAP-034. P1
