...
CAP-003 is an unaccepted candidate that advances the founding algebraic-data-type and
ordinary error-handling direction without claiming general generics. Exact concrete
...
formatting, and correctness-denying Clippy local evidence is green; public LLVM 22,
protected-merge, and post-merge evidence is still pending, so this is not accepted
