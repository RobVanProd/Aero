...
Local candidate CAP-006 advances the founding paper's generic-enum grammar and
...
This remains local candidate evidence. Pinned LLVM/Clang 22 external/machine and
Linux/Windows `-O0`/`-O2` execution, exact-head public workflows, protected merge, and
merge-head acceptance synchronization are pending. Bounds/traits, named variants,
...
Accepted framework truth remains CAP-005.
