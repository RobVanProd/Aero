...
Local candidate `CORE-089` closes that last signature-count partition without adding a
...
target, and doc tests; public gates remain pending. Projections, reference escape/
