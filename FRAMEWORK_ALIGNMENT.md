...
Local candidate `CORE-076` advances the founding description of Match as one strongly
...
wider patterns, and general ownership remain excluded. The composed two-module
candidate is pinned for native exit 223; public acceptance remains pending.
