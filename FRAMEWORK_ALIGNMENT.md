...
The locally green `CORE-063` candidate composes those recursive CopyData values through
...
general enum storage/borrowing, generic enums, new CFG ownership, or a public ABI. Public
LLVM/Clang 22 native-exit-113 evidence remains pending.
...
| Ownership-based safety | Shallow move checks remain partial. CORE-048/053 through accepted CORE-062 establish bounded immutable/mutable whole-place ownership, internal reference transport, direct owner reassignment, and recursive finite CopyData composition while preserving immutable-reference copy behavior without storing references as CopyData. Mutable projections, reference results, escaping provenance, stable reference ABI, general CFG ownership, NLL, drop, lifetime inference, and memory-safety claims remain absent; 16 broader semantic/lossy-shape Phase 5 tests remain quarantined. | Freeze another hard CFG-aware ownership, module, runtime, or execution slice |
| Structs, arrays, enums, traits, and Match | CORE-043 through CORE-047 accept bounded all-Copy scalar/named-struct construction, projection, arrays, transport, and finite acyclic graphs. CORE-049 through CORE-052 accept unit/unary-scalar enums, exhaustive bound Match, and owned internal transport. CORE-058 through CORE-061 add flat tuples, whole-place references, and direct owner replacement. Accepted CORE-062 removes the executable CopyData topology whitelist. The locally green CORE-063 candidate carries that recursive class through unary owned-enum payloads and exact bound Match; pinned public native evidence remains pending. Generic/multi-field enums, Option/Result Match, wildcard/guard/nested destructuring, general enum storage/borrowing/mutation, unit/unary tuples, unsupported/cyclic structs, dynamic arrays, traits, and stable aggregate/reference ABI remain open. | Address another hard generic/module/runtime/ownership class under separately frozen semantics |
