...
Local candidate `CORE-090` takes the next hard ownership step by closing one complete
...
direct-module specimen at exact exit 90. Public gates remain pending. Dynamic indexes,
