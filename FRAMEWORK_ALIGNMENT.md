...
Locally green candidate `CORE-084` takes the complementary bounded step from the
...
exact-head public Linux/Windows LLVM 22 execution is pending. Free enum dereference,
...
excluded. This is framework-aligned candidate evidence, not public acceptance.
