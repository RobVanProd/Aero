...
Local candidate `CORE-077` advances the founding unique-ownership direction through a
...
rejects fabricated repairs. The composed direct-module candidate is pinned for native
...
or loop-fixed-point claims remain excluded.
