...
eight public checks. The selected false-success correction is accepted. R-007 remains
open for real Aero accelerator execution and correctness evidence; no hardware,
numerical, or performance capability is inferred.
