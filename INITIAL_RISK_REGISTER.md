...
freeze a one-branch presentation correction. R-013 remains partially controlled
until tests-first, implementation, full-gate, exact-review, and public evidence pass;
all unselected command, type, ownership, IR, backend, and toolchain risks remain open.
