...
| R-012 | Dormant, duplicated, or ignored tests create false coverage confidence | HIGH | HIGH | `AUDIT-023` at clean `8869eca` classified 38 ignored tests; public-green preregistration `2c61535` selected a strict 22/16 split; the local implementation candidate has exactly 4 strict lexer + 18 strict parser-retention passes, 16 explicit quarantines, 38 listed entries, exact full-gate success, and no production change; Cargo overlap and 299 dormant tests remain | Preserve exact strict token/retained-AST assertions and the 16-test quarantine; report target entries, overlap, distinct evidence, and gates separately | CANDIDATE PARTIALLY CONTROLLED — focused/list/full-gate evidence is green locally, but exact review/public closure remain; no semantic capability change |
