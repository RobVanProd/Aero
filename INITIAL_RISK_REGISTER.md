...
Local candidate `CORE-079` narrows the R-003 ownership-control boundary without
...
negative. Focused 3/3, complete all-features, static, documentation, diff-hygiene, and
exact root gates pass; public/native evidence remains pending, and no borrow, lifetime,
drop, ABI, or safety claim follows.
