...
Local candidate `CORE-075` adds conditional direct-owner transport to that exact result
...
artifact hygiene, and the exact root gate pass locally. Pinned native exit 211 and
all-eight public acceptance remain pending. Calls consuming another owner, external nested scrutinees,
