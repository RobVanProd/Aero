...
protected CAP-024 merge and its accepted tree, with the exact acceptance
identities and current alert state recorded in the CAP-024 section below.
...
absent on the default branch. Default-branch Actions analysis `1612715455` contains only
the pre-existing open alert #4 created 2026-08-09; Python and Rust analyses contain zero
