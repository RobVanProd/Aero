use crate::errors::{
    CompilerError, CompilerErrors, EnhancedError, ErrorContext, ErrorSuggestion, SourceLocation,
};
...
mod tests {
    ...
    fn test_control_flow_errors() {
        ...
        let break_error = CompilerError::BreakOutsideLoop {
            location: location.clone(),
        };
    ...
    fn test_error_suggestion_creation() {
        ...
        let suggestion_with_replacement =
            ErrorSuggestion::with_replacement("Use comparison operator", "==");
        assert_eq!(
            suggestion_with_replacement.message,
            "Use comparison operator"
        );
        assert_eq!(
            suggestion_with_replacement.replacement,
            Some("==".to_string())
        );

        let location = SourceLocation::new(5, 10);
        let suggestion_with_location =
            ErrorSuggestion::with_location("Variable defined here", location.clone());
    ...
    fn test_enhanced_error_creation() {
        ...
        let enhanced = EnhancedError::new(error)
            ...
            .with_context(
                ErrorContext::new().with_variables(vec!["x".to_string(), "y".to_string()]),
            );
    ...
    fn test_undefined_variable_with_suggestions() {
        ...
        let enhanced =
            EnhancedError::undefined_variable_with_suggestions("cout", location, available_vars);
    ...
    fn test_undefined_function_with_suggestions() {
        ...
        let enhanced =
            EnhancedError::undefined_function_with_suggestions("pint", location, available_funcs);
    ...
    fn test_type_mismatch_with_suggestions() {
        ...
        let enhanced =
            EnhancedError::type_mismatch_with_suggestions("i32", "f64", location.clone());
        let error_msg = format!("{}", enhanced);
        ...
        let enhanced =
            EnhancedError::type_mismatch_with_suggestions("bool", "i32", location.clone());
        let error_msg = format!("{}", enhanced);
    ...
    fn test_syntax_error_with_suggestions() {
        ...
        let enhanced =
            EnhancedError::syntax_error_with_suggestions("Invalid syntax", location.clone(), "=");
        let error_msg = format!("{}", enhanced);
        ...
        let enhanced =
            EnhancedError::syntax_error_with_suggestions("Unmatched brace", location, "{");
        let error_msg = format!("{}", enhanced);
    ...
    fn test_control_flow_error_with_context() {
        ...
        let enhanced =
            EnhancedError::control_flow_error_with_context(error, Some("main".to_string()));
    ...
    fn test_mutability_error_with_suggestions() {
        ...
        let enhanced =
            EnhancedError::mutability_error_with_suggestions("x", location, def_location);
    ...
    fn test_compiler_errors_into_result() {
        ...
        let mut errors = CompilerErrors::new();
        errors.add(CompilerError::undefined_variable(
            "x",
